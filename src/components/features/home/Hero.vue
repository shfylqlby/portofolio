<template>
  <section class="bg-gray-900 text-gray-300 px-6 md:px-20 py-20 flex flex-col-reverse md:flex-row items-center justify-between">
    <!-- Text -->
    ...
    <div class="md:w-1/2 flex justify-center mb-10 md:mb-0">
      <img src="/src/assets/killua.png" alt="Hero Image" class="w-72 md:w-96 rounded-lg"/>
    </div>
  </section>
</template>
